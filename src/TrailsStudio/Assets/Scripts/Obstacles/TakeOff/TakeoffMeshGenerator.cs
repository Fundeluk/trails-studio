...
namespace Obstacles.TakeOff
{
    public class TakeoffMeshGenerator : MeshGeneratorBase
    {
        ...
        [SerializeField] private float defaultWidth = 1.5f;
        [SerializeField] private float defaultThickness = 0.5f;
        [SerializeField] private int defaultResolution = 10;
        [SerializeField] private float defaultRadius = 4.0f;
        ...
        private const float ANGLE_START = 270 * Mathf.Deg2Rad;
        private float angleEnd;

        public float GetEndAngle() => angleEnd - ANGLE_START;
        ...
        protected override Vector3[] CreateVertices()
        {
            ...
            for (int i = 0; i <= Resolution; i++)
            {
                ...
                float angle = Mathf.Lerp(ANGLE_START, angleEnd, t);
        ...
        {
            return Radius * (angleEnd - ANGLE_START);
        }
