...
namespace Obstacles.Landing
{
    public class LandingMeshGenerator : MeshGeneratorBase
    {
        ...
        public float Slope
        {
            ...
            set
            {                
                if (!Mathf.Approximately(slope, value))
                {
                    slope = value;
        ...
        /// <returns>What Length does the mesh's flat slope part have in the forward direction in meters.</returns>
