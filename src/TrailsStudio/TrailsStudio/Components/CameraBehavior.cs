...
{
    internal class CameraBehavior : Behavior
    {
        /// <summary>
        /// The camera to move.
        /// </summary>
        ...
        private void HandleKeyboard()
        {
            ...
            var keyboard = this.keyboardDispatcher;

            if (keyboard.IsKeyDown(Keys.W))
            {
                this.cameraTransform.LocalPosition += this.cameraTransform.Forward * 1;
            }
            ...
            {
                this.cameraTransform.LocalPosition -= this.cameraTransform.Right * 1;
            }
